...
@CrossOrigin(origins = {"http://localhost:8080", "http://192.168.160.103:9070"})
public class FlightStateMessageController {
    
    @Autowired
    private FlightStateMessageService flightStateService;
    
    private KafkaIcao24Producer producer = new KafkaIcao24Producer("STATS_REQ_6", Boolean.TRUE);
